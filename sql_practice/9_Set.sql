...
SELECT -- 8 cuz same name, same birth_de but diff emp_no
...
SELECT -- 7 cuz removed the same name, same birth_de
    emp_nm, birth_de
FROM tb_emp
WHERE birth_de BETWEEN '19600101' AND '19691231'
UNION
...
SELECT -- it will pick the first EN, BD
...
FROM tb_emp
WHERE birth_de BETWEEN '19700101' AND '19791231'
ORDER BY BD DESC -- ORDER BY comes after UNION
;
...
SELECT 
    ...
    CONNECT_BY_ISLEAF -- LV4 with No Leaf Nodes
FROM tb_emp A
JOIN tb_dept B
